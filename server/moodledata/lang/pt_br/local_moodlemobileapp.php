...
$string['core.courses.searchcoursesadvice'] = 'Você pode usar o botão de busca para acessar os cursos como convidado ou se matricular em cursos que permitem que ele.';
...
$string['core.login.legacymoodleversion'] = 'Você está tentando se conectar a uma versão do Moodle sem suporte. Por favor, baixe o aplicativo Moodle Classic para acessar este site Moodle.';
$string['core.login.legacymoodleversiondesktop'] = 'Você está tentando se conectar a <b>{{$a}}</ b>. <br /><br />Este site está executando uma versão desatualizada do Moodle, que não funciona com este aplicativo Moodle Desktop. <br/>Se este for seu site, entre em contato com seu  moodle partner para obter suporte para atualizá-lo. <br /> <br />Veja<a href="https://moodle.com/contact"> nossa página de contato</a> para enviar uma solicitação de assistência.';
$string['core.login.legacymoodleversiondesktopdownloadold'] = '<br /><br /> Como alternativa, você ainda pode acessar este site utilizando uma versão sem suporte do aplicativo que pode ser baixada aqui.';
