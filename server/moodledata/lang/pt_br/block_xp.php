...
$string['event_user_leveledup'] = 'Usuário avançou de nível';
...
$string['pluginname'] = 'Subiu de nível!';
...
$string['reallydeleteuserstate'] = 'Deletar um usuário só é útil para removê-lo do ranking. Para outras razões, nós recomendamos setar seus pontos para 0. Note que deletar um usuário não o impede de ganhar pontos no futuro.

Importante! Quando utilizando o _Level up!_ para todo o site, deletar usuários fará com que eles desapareçam do relatório e não será possível dar-lhes pontos. Entretanto, se você estiver usando o _Level up!_ para cursos específicos, o estudante ainda pode aparecer no relatório se eles estão matriculados no curso.

Você realmente deseja deletar os pontos deste usuário?';
