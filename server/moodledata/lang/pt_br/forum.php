...
/**
 * Strings for component 'forum', language 'pt_br', branch 'MOODLE_37_STABLE'
 *
 * @package   forum
...
$string['discussionlistsortbycreatedasc'] = 'Classificar por data de criação em ordem crescente';
...
$string['nowallsubscribed'] = 'Agora você é assinante em todos os fóruns de {$a}.';
$string['nowallunsubscribed'] = 'Agora você não é assinante em nenhum dos fóruns de {$a}.';
...
$string['showingcountoftotaldiscussions'] = 'Mostrando {$a->count} de {$a->total} discussões';
