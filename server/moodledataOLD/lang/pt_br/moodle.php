...
/**
 * Strings for component 'moodle', language 'pt_br', branch 'MOODLE_37_STABLE'
 *
 * @package   moodle
...
$string['timesplitting:upcoming3days_help'] = 'Este método de dividir o tempo gera previsões a cada 3 dias. Os cálculos dos indicadores serão baseados nos próximos 3 dias.';
$string['timesplitting:upcomingfortnight'] = 'Próxima quinzena';
$string['timesplitting:upcomingfortnight_help'] = 'Este método de dividir o tempo gera previsões a cada quinzena. Os cálculos dos indicadores serão baseados na próxima quinzena.';
$string['timesplitting:upcomingweek'] = 'Próxima semana';
$string['timesplitting:upcomingweek_help'] = 'Este método de dividir o tempo gera previsões a cada semana. Os cálculos dos indicadores serão baseados na próxima semana.';
