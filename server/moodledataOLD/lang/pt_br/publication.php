...
/**
 * Strings for component 'publication', language 'pt_br', branch 'MOODLE_37_STABLE'
 *
 * @package   publication
...
$string['allowsubmissionsfromdateh_help'] = 'Você pode determinar o período no qual os estudantes podem enviar arquivos ou aprovar a publicação destes. Durante este período alunos podem editar seus arquivos e retirar sua aprovação para publicação.';
...
$string['configautoimport'] = 'Se preferir que envios dos estudantes sejam automaticamente importadas em instâncias da Pasta do Aluno. Este recurso pode ser ativado/desativado para cada Pasta do Aluno separadamente.';
