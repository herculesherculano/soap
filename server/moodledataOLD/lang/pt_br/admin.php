...
$string['configpasswordpolicy'] = 'Se habilitada, as senhas dos usuários serão comparadas com a política de senhas, conforme definido nas configurações abaixo. A ativação da política de senha não afetará os usuários existentes até que eles decidam ou sejam obrigados a alterar suas senhas.';
...
$string['courselistshortnames_desc'] = 'Se habilitado, o nome breve dos cursos seralém dos nomes completos nas listas de cursos. Se necessário, os nomes destendidos dos cursos podem ser personalizados através da edição da string de idioma \'courseextendednamedisplay\' utilizando o recurso de personalização da linguagem.';
...
$string['croninfrequent'] = 'O tempo entre as duas últimas execuções do script de manutenção do cron ultrapassou {$a} segundos. Recomendamos configurá-lo para ser executado com mais frequência.';
...
$string['task_stats:dbwrites'] = '{$a} registradas';
