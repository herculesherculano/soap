...
/**
 * Strings for component 'tool_monitor', language 'pt_br', branch 'MOODLE_37_STABLE'
 *
...
$string['messagetemplate_help'] = 'Uma mensagem de notificação é enviada aos assinantes assim que o limite de notificação for atingido. Ela pode  incluir qualquer um ou todos os seguintes marcadores:
